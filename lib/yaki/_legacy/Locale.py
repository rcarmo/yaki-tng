...
i18n = {
  'en_US': {
    ...
    'journal_date_format': u'%(month)s %(mday)s<sup>%(suffix)s</sup>',
    ...
    'search_instructions': u'You can use arbitrarily nested Boolean expressions with AND, OR, NOT, etc. "quoted sentences" for exact matches, search inside a field like title: or tags: or even do combined field and wildcard notation such as date:201103* ',
    'quicklook_click_to_zoom': u'Click on the image to zoom in',
    'error_include_file': u'Plugin error: include file failed',
    'error_markup_type': u'Cannot process markup',
    ...
    'rss_update_date_format': u'%(weekday)s, %(month)s %(mday)s<sup>%(suffix)s</sup> %(year)s',
    # Words
    'Day': u'Day',
    'Page': u'Page',
    'Entries': u'Entries',
  ...
  'pt_PT': {
    ...
    'search_instructions': u'Pode usar expressões booleanas arbitrárias com AND, OR, NOT, etc., "frases exactas" ou até combinações de wildcards e nomes de campos como date:201103*',
    ...
    'error_markup_type': u'Não foi possível processar o markup',
    ...
    'rss_update_date_format': u'%(weekday)s, %(mday)s de %(month)s de %(year)s',
    # Words
    'Day': u'Dia',
    'Page': u'Página',
    'Entries': u'Entradas',
